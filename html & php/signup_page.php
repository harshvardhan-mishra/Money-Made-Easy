...
<a href="login_page.php">
    ...
    <a href="home_page.html">
      <button type="submit" class="home">Home</button>
		...
		<label for="fname">First Name<font size="2">&#9733;</font> :
		<input type="text" id="fname" name="fname" placeholder="Enter your First Name" size="40" required onchange="CheckName(fname);"></label><br><br>
		<label for="fname">Last Name<font size="2">&#9733;</font> :
		<input type="text" id="lname" name="lname" placeholder="Enter your First Name" size="40" required onchange="CheckName(fname);"></label><br><br>

		<label for="bank">Bank Name <font size="2">&#9733;</font>&nbsp;:&nbsp;
		<select name="bank" id="bank" onblur="checkselect1();" required>
		...
		<label for="accountno">Account No.<font size="2">&#9733;</font> :
		<input type="text" id="accountno" name="accountno" placeholder="Please Enter your Bank Account No." size="40" required onchange="checkbankacc(accountno);"></label><br><br
		>
		<label for="username">Username<font size="2">&#9733;</font> :
		<input type="text" id="username" name="username" placeholder="Enter a Username of your Choice" size="40"  required onfocus="show(span1);" onblur="document.getElementById('span1').style.display='none';" onchange="CheckUsername(username);"></label><span id="span1">&#9432; Convention: Username should contain only 5 characters which should include atleast one from @,#,$,&</span><br><br>

		<label for="pw">Login Password<font size="2">&#9733;</font> :    
		<input type="password" id="pw" name="pw" required size="40" placeholder="Enter a Password of your choice" onfocus="show(span2);" onblur="document.getElementById('span2').style.display='none';" onchange="CheckPassword(pw);"></label><span id="span2">&#9432; Convention: Password can vary in length from 8-12 characters which should include atleast one from @,#,$,& , it should also have atleast one uppercase and one lower case letter, it should also have atleast one number</span><br><br>

		<label for="cpw"> Confirm Login Password<font size="2">&#9733;</font> : 
		<input type="password" id="cpw" name="cpw" required minlength="8" maxlength="15" onkeyup="check(pw,cpw,message);" size="40" placeholder="Confirm your password"><span id='message'></span></label><br><br>

		<label for="tpw">Transaction Password<font size="2">&#9733;</font> :    
		<input type="password" id="tpw" name="tpw" required size="40" placeholder="Enter a Password of your choice" onfocus="show(span3);" onblur="document.getElementById('span3').style.display='none';" onchange="CheckPassword(tpw);"></label><span id="span3">&#9432; Convention: Password can vary in length from 8-12 characters which should include atleast one from @,#,$,% , it should also have atleast one uppercase and one lower case letter, it should also have atleast one number</span><br><br>

		<label for="tcpw">Confirm Transaction Password<font size="2">&#9733;</font> : 
		<input type="password" id="tcpw" name="tcpw" required size="40" placeholder="Confirm your Transaction password" onkeyup="check(tpw,tcpw,message1);"><span id='message1'></span></label><br><br>

		<label for="contactno">Contact-no<font size="2">&#9733;</font> : </label><input type="tel" name="contactno" id="contactno" onchange="checkcontact(contactno)"><br><br>

		<label for="email">Email Id<font size="2">&#9733;</font> :
		<input type="email" id="email" name="email" placeholder="Enter your Email Id" size="40" required onchange="checkEmail(email);"></label><br><br>

		<center><font size="2">&#9733; mandatory fields</font><br><br>	
		<input type="submit" name="signupbtn" class="btn1" value="Submit"></center></form></div>
