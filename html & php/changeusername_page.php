...
<a href="confirmlogout.php">
	...
	<div class="changeusername">
		...
		<form action="changeusername_action.php" method="post">
			<label for="oldusername">Enter Old Username <font size="2">&#9733;</font> :&nbsp;
			<input type="text" name="oldusername" id="oldusername"></label><br><br>
			<label for="newusername">Enter New Username <font size="2">&#9733;</font> :&nbsp;
			<input type="text" name="newusername" id="newusername" onchange="CheckUsername1(newusername)"></label><br><br>
			<label for="renewusername">Confirm New Username <font size="2">&#9733;</font> :&nbsp;
			<input type="text" name="renewusername" id="renewusername" onkeyup="check(newusername,renewusername,message)" onfocus="hide(newusername);" onblur="show1(newusername);"><span id="message"></span></label><br><br>
